            ...
            <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content text-center" style="padding: 30px;">
                        ...
                        <form class="form-horizontal" action="/controler/addGolos.php" method="POST">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-sm-offset-1 col-sm-10 text-center">
                                    <input type="text" name="title_golos" class="form-control " >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-offset-1 col-sm-10 text-center">
                                    <textarea  class="form-control" rows="6" name="text_golos"></textarea>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-9" style="">
